...
func NewSingular(ns, name string) runtime.Object {
	...
	return &servicecatalog.ClusterServiceClass{TypeMeta: metav1.TypeMeta{Kind: "ClusterServiceClass"}, ObjectMeta: metav1.ObjectMeta{Namespace: ns, Name: name}}
}
...
func NewList() runtime.Object {
	_logClusterCodePath()
	defer _logClusterCodePath()
	return &servicecatalog.ClusterServiceClassList{TypeMeta: metav1.TypeMeta{Kind: "ClusterServiceClassList"}, Items: []servicecatalog.ClusterServiceClass{}}
}
...
func NewStorage(opts server.Options) (rest.Storage, rest.Storage) {
	...
	storageInterface, dFunc := opts.GetStorage(&servicecatalog.ClusterServiceClass{}, prefix, clusterServiceClassRESTStrategies, NewList, nil, storage.NoTriggerPublisher)
