...
func NewSingular(ns, name string) runtime.Object {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	return &servicecatalog.ClusterServiceBroker{TypeMeta: metav1.TypeMeta{Kind: "ClusterServiceBroker"}, ObjectMeta: metav1.ObjectMeta{Namespace: ns, Name: name}}
}
...
func NewList() runtime.Object {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	return &servicecatalog.ClusterServiceBrokerList{TypeMeta: metav1.TypeMeta{Kind: "ClusterServiceBrokerList"}, Items: []servicecatalog.ClusterServiceBroker{}}
}
...
func NewStorage(opts server.Options) (clusterServiceBrokers, clusterServiceBrokerStatus rest.Storage) {
	...
	storageInterface, dFunc := opts.GetStorage(&servicecatalog.ClusterServiceBroker{}, prefix, clusterServiceBrokerRESTStrategies, NewList, nil, storage.NoTriggerPublisher)
	...
	}, PredicateFunc: Match, DefaultQualifiedResource: servicecatalog.Resource("clusterservicebrokers"), CreateStrategy: clusterServiceBrokerRESTStrategies, UpdateStrategy: clusterServiceBrokerRESTStrategies, DeleteStrategy: clusterServiceBrokerRESTStrategies, EnableGarbageCollection: true, TableConvertor: tableconvertor.NewTableConvertor([]metav1beta1.TableColumnDefinition{{Name: "Name", Type: "string", Format: "name"}, {Name: "URL", Type: "string"}, {Name: "Status", Type: "string"}, {Name: "Age", Type: "string"}}, func(obj runtime.Object, m metav1.Object, name, age string) ([]interface{}, error) {
