...
var _ = Describe("Instances", func() {
	...
	BeforeEach(func() {
		...
		si.Status.Conditions = append(si.Status.Conditions, v1beta1.ServiceInstanceCondition{Type: v1beta1.ServiceInstanceConditionReady, Status: v1beta1.ConditionTrue})
		si2 = &v1beta1.ServiceInstance{ObjectMeta: metav1.ObjectMeta{Name: "barbaz", Namespace: "foobar_namespace"}}
		si2.Status.Conditions = append(si2.Status.Conditions, v1beta1.ServiceInstanceCondition{Type: v1beta1.ServiceInstanceConditionFailed, Status: v1beta1.ConditionTrue})
	...
	Describe("RetrieveInstancesByPlan", func() {
		It("Calls the generated v1beta1 List method with a ListOption containing the passed in plan", func() {
			plan := &v1beta1.ClusterServicePlan{ObjectMeta: metav1.ObjectMeta{Name: "foobar_plan"}, Spec: v1beta1.ClusterServicePlanSpec{}}
			si = &v1beta1.ServiceInstance{ObjectMeta: metav1.ObjectMeta{Name: "foobar", Namespace: "foobar_namespace"}, Spec: v1beta1.ServiceInstanceSpec{ClusterServicePlanRef: &v1beta1.ClusterObjectReference{Name: plan.Name}}}
	...
	Describe("UpdateInstance", func() {
		It("Properly increments the update requests field", func() {
			...
			retries := 3
			opts := &ProvisionOptions{ExternalID: "", Namespace: namespace, Params: params, Secrets: secrets}
			provisionedInstance, err := sdk.Provision(instanceName, className, planName, opts)
			Expect(err).To(BeNil())
			actions := svcCatClient.Actions()
			Expect(len(actions)).To(Equal(1))
			Expect(sdk.TouchInstance(provisionedInstance.Namespace, provisionedInstance.Name, retries)).To(BeNil())
			actions = svcCatClient.Actions()
	...
	Describe("InstanceParentHierarchy", func() {
		It("calls the v1beta1 generated Get function repeatedly to build the heirarchy of the passed in service isntance", func() {
			...
			class := &v1beta1.ClusterServiceClass{ObjectMeta: metav1.ObjectMeta{Name: "foobar_class"}, Spec: v1beta1.ClusterServiceClassSpec{ClusterServiceBrokerName: broker.Name}}
			plan := &v1beta1.ClusterServicePlan{ObjectMeta: metav1.ObjectMeta{Name: "foobar_plan"}, Spec: v1beta1.ClusterServicePlanSpec{}}
			si = &v1beta1.ServiceInstance{ObjectMeta: metav1.ObjectMeta{Name: "foobar", Namespace: "foobar_namespace"}, Spec: v1beta1.ServiceInstanceSpec{ClusterServicePlanRef: &v1beta1.ClusterObjectReference{Name: plan.Name}, ClusterServiceClassRef: &v1beta1.ClusterObjectReference{Name: class.Name}}}
			...
			actions := linkedClient.Actions()
			getClass := testing.GetActionImpl{ActionImpl: testing.ActionImpl{Verb: "get", Resource: schema.GroupVersionResource{Group: "servicecatalog.k8s.io", Version: "v1beta1", Resource: "clusterserviceclasses"}}, Name: class.Name}
			getPlan := testing.GetActionImpl{ActionImpl: testing.ActionImpl{Verb: "get", Resource: schema.GroupVersionResource{Group: "servicecatalog.k8s.io", Version: "v1beta1", Resource: "clusterserviceplans"}}, Name: plan.Name}
			getBroker := testing.GetActionImpl{ActionImpl: testing.ActionImpl{Verb: "get", Resource: schema.GroupVersionResource{Group: "servicecatalog.k8s.io", Version: "v1beta1", Resource: "clusterservicebrokers"}}, Name: broker.Name}
		...
		It("Bubbles up errors", func() {
			si = &v1beta1.ServiceInstance{ObjectMeta: metav1.ObjectMeta{Name: "foobar", Namespace: "foobar_namespace"}, Spec: v1beta1.ServiceInstanceSpec{ClusterServicePlanRef: &v1beta1.ClusterObjectReference{Name: "not_real_plan"}, ClusterServiceClassRef: &v1beta1.ClusterObjectReference{Name: "not_real_class"}}}
			badClient := &fake.Clientset{}
	...
	Describe("InstanceToServiceClassAndPlan", func() {
		It("Calls the generated v1beta methods with the names of the class and plan from the passed in instance", func() {
			class := &v1beta1.ClusterServiceClass{ObjectMeta: metav1.ObjectMeta{Name: "foobar_class"}}
			plan := &v1beta1.ClusterServicePlan{ObjectMeta: metav1.ObjectMeta{Name: "foobar_plan"}, Spec: v1beta1.ClusterServicePlanSpec{}}
			si = &v1beta1.ServiceInstance{ObjectMeta: metav1.ObjectMeta{Name: "foobar", Namespace: "foobar_namespace"}, Spec: v1beta1.ServiceInstanceSpec{ClusterServicePlanRef: &v1beta1.ClusterObjectReference{Name: plan.Name}, ClusterServiceClassRef: &v1beta1.ClusterObjectReference{Name: class.Name}}}
	...
	Describe("Provision", func() {
		It("Calls the v1beta1 Create method with the passed in arguments", func() {
			...
			secrets["username"] = "admin"
			secrets["password"] = "abc123"
			opts := &ProvisionOptions{ExternalID: externalID, Namespace: namespace, Params: params, Secrets: secrets}
			...
			param := v1beta1.ParametersFromSource{SecretKeyRef: &v1beta1.SecretKeyReference{Name: "username", Key: "admin"}}
			param2 := v1beta1.ParametersFromSource{SecretKeyRef: &v1beta1.SecretKeyReference{Name: "password", Key: "abc123"}}
