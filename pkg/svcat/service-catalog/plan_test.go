...
var _ = Describe("Plan", func() {
	...
	BeforeEach(func() {
		...
		csp2 = &v1beta1.ClusterServicePlan{ObjectMeta: metav1.ObjectMeta{Name: "clusterscopedplan"}, Spec: v1beta1.ClusterServicePlanSpec{ClusterServiceClassRef: v1beta1.ClusterObjectReference{Name: csc.Name}}}
		sc = &v1beta1.ServiceClass{ObjectMeta: metav1.ObjectMeta{Name: "somenamespacedclass", Namespace: "default"}}
		sp = &v1beta1.ServicePlan{ObjectMeta: metav1.ObjectMeta{Name: "foobar", Namespace: sc.Namespace}, Spec: v1beta1.ServicePlanSpec{ServiceClassRef: v1beta1.LocalObjectReference{Name: sc.Name}}}
