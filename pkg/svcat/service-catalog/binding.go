...
func (sdk *SDK) Bind(namespace, bindingName, externalID, instanceName, secretName string, params interface{}, secrets map[string]string) (*v1beta1.ServiceBinding, error) {
	...
	request := &v1beta1.ServiceBinding{ObjectMeta: v1.ObjectMeta{Name: bindingName, Namespace: namespace}, Spec: v1beta1.ServiceBindingSpec{ExternalID: externalID, InstanceRef: v1beta1.LocalObjectReference{Name: instanceName}, SecretName: secretName, Parameters: BuildParameters(params), ParametersFrom: BuildParametersFrom(secrets)}}
...
func (sdk *SDK) DeleteBindings(bindings []types.NamespacedName) ([]types.NamespacedName, error) {
	...
	bindErr := &multierror.Error{ErrorFormat: func(errors []error) string {
