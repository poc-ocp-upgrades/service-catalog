...
var _ = Describe("Secret", func() {
	...
	BeforeEach(func() {
		readyBinding = &v1beta1.ServiceBinding{ObjectMeta: metav1.ObjectMeta{Name: "foobar", Namespace: "foobar_namespace"}, Spec: v1beta1.ServiceBindingSpec{SecretName: "mysecret"}, Status: v1beta1.ServiceBindingStatus{Conditions: []v1beta1.ServiceBindingCondition{{Type: v1beta1.ServiceBindingConditionReady, Status: v1beta1.ConditionTrue}}}}
		unreadyBinding = &v1beta1.ServiceBinding{ObjectMeta: metav1.ObjectMeta{Name: "barbaz", Namespace: "foobar_namespace"}, Spec: v1beta1.ServiceBindingSpec{SecretName: "missing-secret"}}
		...
		sdk = &SDK{K8sClient: k8sClient, ServiceCatalogClient: svcCatClient}
	})
