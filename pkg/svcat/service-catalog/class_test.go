...
var _ = Describe("Class", func() {
	...
	Describe("RetrieveClasses", func() {
		...
		It("Bubbles up errors", func() {
			...
			sdk = &SDK{ServiceCatalogClient: badClient}
	...
	Describe("RetrieveClassByName", func() {
		It("Calls the generated v1beta1 List method with the passed in class name", func() {
			...
			sdk = &SDK{ServiceCatalogClient: realClient}
		...
		It("Bubbles up errors", func() {
			...
			sdk = &SDK{ServiceCatalogClient: emptyClient}
			class, err := sdk.RetrieveClassByName(className, ScopeOptions{Scope: AllScope})
	...
	Describe("RetrieveClassByPlan", func() {
		It("Calls the generated v1beta1 get method with the plan's parent service class's name", func() {
			classPlan := &v1beta1.ClusterServicePlan{ObjectMeta: metav1.ObjectMeta{Name: "foobar_plan"}, Spec: v1beta1.ClusterServicePlanSpec{ClusterServiceClassRef: v1beta1.ClusterObjectReference{Name: csc.Name}}}
			realClient := &fake.Clientset{}
			realClient.AddReactor("get", "clusterserviceclasses", func(action testing.Action) (bool, runtime.Object, error) {
				return true, csc, nil
			})
		...
		It("Bubbles up errors", func() {
			...
			errorMessage := "not found"
			classPlan := &v1beta1.ClusterServicePlan{ObjectMeta: metav1.ObjectMeta{Name: "foobar_plan"}, Spec: v1beta1.ClusterServicePlanSpec{ClusterServiceClassRef: v1beta1.ClusterObjectReference{Name: fakeClassName}}}
			badClient := &fake.Clientset{}
