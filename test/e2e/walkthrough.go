...
var _ = framework.ServiceCatalogDescribe("walkthrough", func() {
	...
	It("Runs through the walkthrough", func() {
		...
		broker := &v1beta1.ClusterServiceBroker{ObjectMeta: metav1.ObjectMeta{Name: brokerName}, Spec: v1beta1.ClusterServiceBrokerSpec{CommonServiceBrokerSpec: v1beta1.CommonServiceBrokerSpec{URL: url}}}
		...
		instance := &v1beta1.ServiceInstance{ObjectMeta: metav1.ObjectMeta{Name: instanceName, Namespace: testnamespace.Name}, Spec: v1beta1.ServiceInstanceSpec{PlanReference: v1beta1.PlanReference{ClusterServiceClassExternalName: serviceclassName, ClusterServicePlanExternalName: "default"}}}
		...
		err = util.WaitForInstanceCondition(f.ServiceCatalogClientSet.ServicecatalogV1beta1(), testnamespace.Name, instanceName, v1beta1.ServiceInstanceCondition{Type: v1beta1.ServiceInstanceConditionReady, Status: v1beta1.ConditionTrue})
		...
		binding := &v1beta1.ServiceBinding{ObjectMeta: metav1.ObjectMeta{Name: bindingName, Namespace: testnamespace.Name}, Spec: v1beta1.ServiceBindingSpec{InstanceRef: v1beta1.LocalObjectReference{Name: instanceName}, SecretName: "my-secret"}}
		...
		_, err = util.WaitForBindingCondition(f.ServiceCatalogClientSet.ServicecatalogV1beta1(), testnamespace.Name, bindingName, v1beta1.ServiceBindingCondition{Type: v1beta1.ServiceBindingConditionReady, Status: v1beta1.ConditionTrue})
		...
		instanceDef := &v1beta1.ServiceInstance{ObjectMeta: metav1.ObjectMeta{Name: instanceNameDef, Namespace: testnamespace.Name}, Spec: v1beta1.ServiceInstanceSpec{PlanReference: v1beta1.PlanReference{ClusterServiceClassExternalName: serviceclassNameWithSinglePlan}}}
		...
		By("Waiting for ServiceInstance to be ready")
		err = util.WaitForInstanceCondition(f.ServiceCatalogClientSet.ServicecatalogV1beta1(), testnamespace.Name, instanceNameDef, v1beta1.ServiceInstanceCondition{Type: v1beta1.ServiceInstanceConditionReady, Status: v1beta1.ConditionTrue})
		...
		instanceK8SNames := &v1beta1.ServiceInstance{ObjectMeta: metav1.ObjectMeta{Name: instanceNameK8sNames, Namespace: testnamespace.Name}, Spec: v1beta1.ServiceInstanceSpec{PlanReference: v1beta1.PlanReference{ClusterServiceClassName: serviceclassID, ClusterServicePlanName: serviceplanID}}}
		...
		err = util.WaitForInstanceCondition(f.ServiceCatalogClientSet.ServicecatalogV1beta1(), testnamespace.Name, instanceNameK8sNames, v1beta1.ServiceInstanceCondition{Type: v1beta1.ServiceInstanceConditionReady, Status: v1beta1.ConditionTrue})
		...
		instanceK8SNamesDef := &v1beta1.ServiceInstance{ObjectMeta: metav1.ObjectMeta{Name: instanceNameK8sNamesDef, Namespace: testnamespace.Name}, Spec: v1beta1.ServiceInstanceSpec{PlanReference: v1beta1.PlanReference{ClusterServiceClassName: serviceclassIDWithSinglePlan}}}
		...
		err = util.WaitForInstanceCondition(f.ServiceCatalogClientSet.ServicecatalogV1beta1(), testnamespace.Name, instanceNameK8sNamesDef, v1beta1.ServiceInstanceCondition{Type: v1beta1.ServiceInstanceConditionReady, Status: v1beta1.ConditionTrue})
