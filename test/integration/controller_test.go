...
func TestBasicFlows(t *testing.T) {
	...
	}{{name: "sync"}, {name: "async instances", asyncForInstances: true}, {name: "async bindings", asyncForBindings: true}, {name: "async instances and bindings", asyncForInstances: true, asyncForBindings: true}}
...
func TestBindingFailure(t *testing.T) {
	...
	ct.run(func(ct *controllerTest) {
		condition := v1beta1.ServiceBindingCondition{Type: v1beta1.ServiceBindingConditionFailed, Status: v1beta1.ConditionTrue}
...
func TestBasicFlowsWithOriginatingIdentity(t *testing.T) {
	...
	ct := &controllerTest{t: t, broker: getTestBroker(), instance: getTestInstance(), binding: getTestBinding(), preCreateInstance: createChangeUsernameFunc("instance-creator"), postCreateInstance: createVerifyUsernameFunc(fakeosb.ProvisionInstance, "instance-creator"), preDeleteInstance: createChangeUsernameFunc("instance-deleter"), postDeleteInstance: createVerifyUsernameFunc(fakeosb.DeprovisionInstance, "instance-deleter"), preCreateBinding: createChangeUsernameFunc("binding-creator"), postCreateBinding: createVerifyUsernameFunc(fakeosb.Bind, "binding-creator"), preDeleteBinding: createChangeUsernameFunc("binding-deleter"), postDeleteBinding: createVerifyUsernameFunc(fakeosb.Unbind, "binding-deleter")}
	ct.run(func(ct *controllerTest) {
...
func TestServiceBindingOrphanMitigation(t *testing.T) {
	...
	ct.run(func(ct *controllerTest) {
		...
		util.AssertServiceBindingCondition(t, retBinding, v1beta1.ServiceBindingConditionReady, v1beta1.ConditionFalse, "OrphanMitigationSuccessful")
	})
}
...
func TestServiceInstanceDeleteWithAsyncUpdateInProgress(t *testing.T) {
	...
	cases := []struct {
		name		string
		updateSucceeds	bool
	}{{name: "update succeeds", updateSucceeds: true}, {name: "update fails", updateSucceeds: false}}
	for _, tc := range cases {
		tc := tc
		t.Run(tc.name, func(t *testing.T) {
			var done int32 = 0
			ct := controllerTest{t: t, broker: getTestBroker(), instance: getTestInstance(), skipVerifyingInstanceSuccess: false, setup: func(ct *controllerTest) {
				ct.osbClient.UpdateInstanceReaction.(*fakeosb.UpdateInstanceReaction).Response.Async = true
				ct.osbClient.PollLastOperationReaction = fakeosb.DynamicPollLastOperationReaction(func(_ *osb.LastOperationRequest) (*osb.LastOperationResponse, error) {
					state := osb.StateInProgress
			...
			ct.run(func(ct *controllerTest) {
				if err := util.WaitForInstanceCondition(ct.client, ct.instance.Namespace, ct.instance.Name, v1beta1.ServiceInstanceCondition{Type: v1beta1.ServiceInstanceConditionReady, Status: v1beta1.ConditionTrue, Reason: "ProvisionedSuccessfully"}); err != nil {
				...
				if err := util.WaitForInstanceCondition(ct.client, ct.instance.Namespace, ct.instance.Name, v1beta1.ServiceInstanceCondition{Type: v1beta1.ServiceInstanceConditionReady, Status: v1beta1.ConditionFalse, Reason: "UpdatingInstance"}); err != nil {
...
func TestServiceInstanceDeleteWithAsyncProvisionInProgress(t *testing.T) {
	...
	}{{name: "provision succeeds", provisionSucceeds: true}, {name: "provision fails", provisionSucceeds: false}}
	for _, tc := range cases {
		tc := tc
		t.Run(tc.name, func(t *testing.T) {
			var done int32 = 0
			...
			ct.run(func(ct *controllerTest) {
				if err := util.WaitForInstanceCondition(ct.client, ct.instance.Namespace, ct.instance.Name, v1beta1.ServiceInstanceCondition{Type: v1beta1.ServiceInstanceConditionReady, Status: v1beta1.ConditionFalse, Reason: "Provisioning"}); err != nil {
...
func TestServiceBindingDeleteWithAsyncBindInProgress(t *testing.T) {
	...
	cases := []struct {
		name		string
		bindSucceeds	bool
	}{{name: "bind succeeds", bindSucceeds: true}, {name: "bind fails", bindSucceeds: false}}
	for _, tc := range cases {
		tc := tc
		t.Run(tc.name, func(t *testing.T) {
			utilfeature.DefaultFeatureGate.Set(fmt.Sprintf("%v=true", scfeatures.AsyncBindingOperations))
			...
			ct := controllerTest{t: t, broker: getTestBroker(), instance: getTestInstance(), binding: getTestBinding(), skipVerifyingBindingSuccess: true, setup: func(ct *controllerTest) {
				ct.osbClient.BindReaction.(*fakeosb.BindReaction).Response.Async = true
				ct.osbClient.PollBindingLastOperationReaction = fakeosb.DynamicPollBindingLastOperationReaction(func(_ *osb.BindingLastOperationRequest) (*osb.LastOperationResponse, error) {
					state := osb.StateInProgress
					d := atomic.LoadInt32(&done)
					if d > 0 {
						if tc.bindSucceeds {
			...
			ct.run(func(ct *controllerTest) {
				if _, err := util.WaitForBindingCondition(ct.client, ct.binding.Namespace, ct.binding.Name, v1beta1.ServiceBindingCondition{Type: v1beta1.ServiceBindingConditionReady, Status: v1beta1.ConditionFalse, Reason: "Binding"}); err != nil {
...
func getProvisionResponseByPollCountReactions(numOfResponses int, stateProgressions []fakeosb.ProvisionReaction) fakeosb.DynamicProvisionReaction {
	...
	return func(_ *osb.ProvisionRequest) (*osb.ProvisionResponse, error) {
		...
		if reaction.Response != nil {
			return &osb.ProvisionResponse{Async: reaction.Response.Async, OperationKey: reaction.Response.OperationKey}, nil
		}
...
func getDeprovisionResponseByPollCountReactions(numOfResponses int, stateProgressions []fakeosb.DeprovisionReaction) fakeosb.DynamicDeprovisionReaction {
	...
	return func(_ *osb.DeprovisionRequest) (*osb.DeprovisionResponse, error) {
		...
		numberOfPolls++
		if reaction.Response != nil {
			return &osb.DeprovisionResponse{Async: reaction.Response.Async, OperationKey: reaction.Response.OperationKey}, nil
		}
		return nil, reaction.Error
	}
}
func getUpdateInstanceResponseByPollCountReactions(numOfResponses int, stateProgressions []fakeosb.UpdateInstanceReaction) fakeosb.DynamicUpdateInstanceReaction {
	...
	return func(_ *osb.UpdateInstanceRequest) (*osb.UpdateInstanceResponse, error) {
		...
		numberOfPolls++
		if reaction.Response != nil {
			return &osb.UpdateInstanceResponse{Async: reaction.Response.Async, OperationKey: reaction.Response.OperationKey}, nil
		}
		return nil, reaction.Error
	}
}
...
func newControllerTestTestController(ct *controllerTest) (*fake.Clientset, clientset.Interface, *restclient.Config, *fakeosb.FakeClient, controller.Controller, informers.Interface, func(), func()) {
	...
	testController, err := controller.NewController(fakeKubeClient, catalogClient.ServicecatalogV1beta1(), serviceCatalogSharedInformers.ClusterServiceBrokers(), serviceCatalogSharedInformers.ServiceBrokers(), serviceCatalogSharedInformers.ClusterServiceClasses(), serviceCatalogSharedInformers.ServiceClasses(), serviceCatalogSharedInformers.ServiceInstances(), serviceCatalogSharedInformers.ServiceBindings(), serviceCatalogSharedInformers.ClusterServicePlans(), serviceCatalogSharedInformers.ServicePlans(), brokerClFunc, 24*time.Hour, osb.LatestAPIVersion().HeaderValue(), fakeRecorder, 7*24*time.Hour, 7*24*time.Hour, controller.DefaultClusterIDConfigMapName, controller.DefaultClusterIDConfigMapNamespace)
...
func prependGetSecretReaction(fakeKubeClient *fake.Clientset, secretName string, secretData map[string][]byte) {
	...
	fakeKubeClient.PrependReactor("get", "secrets", func(action clientgotesting.Action) (bool, runtime.Object, error) {
		...
		secret := &corev1.Secret{ObjectMeta: metav1.ObjectMeta{Namespace: testNamespace, Name: secretName}, Data: secretData}
...
func getTestFilteredBroker(serviceClassRestrictions, servicePlanRestrictions []string) *v1beta1.ClusterServiceBroker {
	...
	testBroker.Spec.CatalogRestrictions = &v1beta1.CatalogRestrictions{ServiceClass: serviceClassRestrictions, ServicePlan: servicePlanRestrictions}
	return testBroker
}
