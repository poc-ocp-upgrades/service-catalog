...
func TestCreateServiceBindingSuccess(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			ct := &controllerTest{t: t, broker: getTestBroker(), instance: getTestInstance(), binding: getTestBinding()}
...
func TestCreateServiceBindingInvalidInstanceFailure(t *testing.T) {
	...
	cases := []struct {
		name		string
		instanceName	*string
	}{{name: "invalid service instance name", instanceName: strPtr("")}}
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
...
func TestCreateServiceBindingInvalidInstance(t *testing.T) {
	...
	}{{name: "non-existent service instance name", instanceName: strPtr("nothereinstance"), condition: v1beta1.ServiceBindingCondition{Type: v1beta1.ServiceBindingConditionReady, Status: v1beta1.ConditionFalse, Reason: "ReferencesNonexistentInstance"}}}
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			ct := &controllerTest{t: t, broker: getTestBroker(), instance: getTestInstance(), binding: func() *v1beta1.ServiceBinding {
				b := getTestBinding()
				if tc.instanceName != nil {
...
func TestCreateServiceBindingNonBindable(t *testing.T) {
	...
	cases := []struct {
		...
		condition	v1beta1.ServiceBindingCondition
	}{{name: "non-bindable plan", nonbindablePlan: true, condition: v1beta1.ServiceBindingCondition{Type: v1beta1.ServiceBindingConditionReady, Status: v1beta1.ConditionFalse, Reason: "ErrorNonbindableServiceClass"}}}
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			ct := &controllerTest{t: t, broker: getTestBroker(), instance: func() *v1beta1.ServiceInstance {
				...
				return i
			}(), binding: getTestBinding(), skipVerifyingBindingSuccess: true}
			ct.run(func(ct *controllerTest) {
				if cond, err := util.WaitForBindingCondition(ct.client, testNamespace, testBindingName, tc.condition); err != nil {
					t.Fatalf("error waiting for binding condition: %v\n"+"expecting: %+v\n"+"last seen: %+v", err, tc.condition, cond)
				}
...
func TestCreateServiceBindingInstanceNotReady(t *testing.T) {
	...
	cases := []struct {
		...
		condition		v1beta1.ServiceBindingCondition
	}{{name: "service instance not ready", instanceNotReady: true, condition: v1beta1.ServiceBindingCondition{Type: v1beta1.ServiceBindingConditionReady, Status: v1beta1.ConditionFalse, Reason: "ErrorInstanceNotReady"}}}
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			ct := &controllerTest{t: t, broker: getTestBroker(), instance: getTestInstance(), binding: getTestBinding(), setup: func(ct *controllerTest) {
				if tc.instanceNotReady {
					reactionError := osb.HTTPStatusCodeError{StatusCode: http.StatusBadGateway, ErrorMessage: strPtr("error message"), Description: strPtr("response description")}
					ct.osbClient.ProvisionReaction = &fakeosb.ProvisionReaction{Error: reactionError}
	...
	for _, tc := range cases {
		...
		t.Run(tc.name, func(t *testing.T) {
			ct := &controllerTest{t: t, broker: getTestBroker(), instance: getTestInstance(), binding: func() *v1beta1.ServiceBinding {
				...
				return b
			}(), skipVerifyingBindingSuccess: tc.expectedError, setup: func(ct *controllerTest) {
			...
			ct.run(func(ct *controllerTest) {
				if tc.expectedError {
					condition := v1beta1.ServiceBindingCondition{Type: v1beta1.ServiceBindingConditionReady, Status: v1beta1.ConditionFalse, Reason: "ErrorWithParameters"}
					if cond, err := util.WaitForBindingCondition(ct.client, testNamespace, testBindingName, condition); err != nil {
						t.Fatalf("error waiting for binding condition: %v\n"+"expecting: %+v\n"+"last seen: %+v", err, condition, cond)
					}
				} else {
...
func TestCreateServiceBindingWithSecretTransform(t *testing.T) {
	...
	}{{name: "no transform", secretTransforms: nil, expectedSecretData: map[string][]byte{"foo": []byte("bar"), "baz": []byte("zap")}}, {name: "rename non-existent key", secretTransforms: []v1beta1.SecretTransform{{RenameKey: &v1beta1.RenameKeyTransform{From: "non-existent-key", To: "bar"}}}, expectedSecretData: map[string][]byte{"foo": []byte("bar"), "baz": []byte("zap")}}, {name: "multiple transforms", secrets: []secretDef{{name: "other-secret", data: map[string][]byte{"key-from-other-secret": []byte("qux")}}}, secretTransforms: []v1beta1.SecretTransform{{AddKey: &v1beta1.AddKeyTransform{Key: "addedStringValue", StringValue: strPtr("stringValue")}}, {AddKey: &v1beta1.AddKeyTransform{Key: "addedByteArray", Value: []byte("byteArray")}}, {AddKey: &v1beta1.AddKeyTransform{Key: "valueFromJSONPath", JSONPathExpression: strPtr("{.foo}")}}, {RenameKey: &v1beta1.RenameKeyTransform{From: "foo", To: "bar"}}, {AddKeysFrom: &v1beta1.AddKeysFromTransform{SecretRef: &v1beta1.ObjectReference{Name: "other-secret", Namespace: "some-namespace"}}}, {RemoveKey: &v1beta1.RemoveKeyTransform{Key: "baz"}}}, expectedSecretData: map[string][]byte{"addedStringValue": []byte("stringValue"), "addedByteArray": []byte("byteArray"), "valueFromJSONPath": []byte("bar"), "bar": []byte("bar"), "key-from-other-secret": []byte("qux")}}}
	for _, tc := range cases {
		tc := tc
		t.Run(tc.name, func(t *testing.T) {
			ct := &controllerTest{t: t, broker: getTestBroker(), instance: getTestInstance(), binding: func() *v1beta1.ServiceBinding {
...
func TestDeleteServiceBindingFailureRetry(t *testing.T) {
	...
	numberOfAttempts := 0
	ct := &controllerTest{t: t, broker: getTestBroker(), instance: getTestInstance(), binding: getTestBinding(), setup: func(ct *controllerTest) {
		ct.osbClient.UnbindReaction = fakeosb.DynamicUnbindReaction(func(_ *osb.UnbindRequest) (*osb.UnbindResponse, error) {
			numberOfAttempts++
			if numberOfAttempts > NumberOfUnbindFailures {
				return &osb.UnbindResponse{}, nil
			}
			return nil, osb.HTTPStatusCodeError{StatusCode: 500, Description: strPtr("test error unbinding")}
		})
	}}
