	...
	for _, tc := range cases {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			ct.run(func(ct *controllerTest) {
				...
				condition := v1beta1.ServiceInstanceCondition{Type: v1beta1.ServiceInstanceConditionReady, Status: status, Reason: tc.expectedErrorReason}
...
func TestCreateServiceInstanceNonExistentClusterServiceBroker(t *testing.T) {
	...
	ct := &controllerTest{t: t, instance: getTestInstance(), skipVerifyingInstanceSuccess: true, preCreateInstance: func(ct *controllerTest) {
		...
		servicePlan := &v1beta1.ClusterServicePlan{ObjectMeta: metav1.ObjectMeta{Name: testPlanExternalID}, Spec: v1beta1.ClusterServicePlanSpec{ClusterServiceBrokerName: testClusterServiceBrokerName, CommonServicePlanSpec: v1beta1.CommonServicePlanSpec{ExternalID: testPlanExternalID, ExternalName: testClusterServicePlanName, Description: "a test plan"}, ClusterServiceClassRef: v1beta1.ClusterObjectReference{Name: testClusterServiceClassGUID}}}
	...
	ct.run(func(ct *controllerTest) {
		if err := util.WaitForInstanceCondition(ct.client, testNamespace, testInstanceName, v1beta1.ServiceInstanceCondition{Type: v1beta1.ServiceInstanceConditionReady, Status: v1beta1.ConditionFalse, Reason: "ReferencesNonexistentBroker"}); err != nil {
	...
	for _, tc := range cases {
		...
		t.Run(tc.name, func(t *testing.T) {
			ct := &controllerTest{t: t, broker: getTestBroker(), instance: func() *v1beta1.ServiceInstance {
				...
				return i
			}(), skipVerifyingInstanceSuccess: tc.expectedError, setup: func(ct *controllerTest) {
			...
			ct.run(func(ct *controllerTest) {
				if tc.expectedError {
					if err := util.WaitForInstanceCondition(ct.client, testNamespace, testInstanceName, v1beta1.ServiceInstanceCondition{Type: v1beta1.ServiceInstanceConditionReady, Status: v1beta1.ConditionFalse, Reason: "ErrorWithParameters"}); err != nil {
						t.Fatalf("error waiting for instance reconciliation to fail: %v", err)
					}
				} else {
...
func TestUpdateServiceInstanceNewDashboardResponse(t *testing.T) {
	...
	}{{name: "alpha features enabled", setup: func(ct *controllerTest) {
	...
	}, osbResponse: &osb.UpdateInstanceResponse{DashboardURL: &dashURL}}, {name: "alpha feature disabled", setup: func(ct *controllerTest) {
		if err := utilfeature.DefaultFeatureGate.Set(fmt.Sprintf("%v=false", scfeatures.UpdateDashboardURL)); err != nil {
			t.Fatalf("Failed to enable updatable dashboard url feature: %v", err)
		}
	}, osbResponse: &osb.UpdateInstanceResponse{DashboardURL: &dashURL}}}
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			ct := &controllerTest{t: t, broker: getTestBroker(), instance: getTestInstance(), setup: func(ct *controllerTest) {
				ct.osbClient.UpdateInstanceReaction = &fakeosb.UpdateInstanceReaction{Response: tc.osbResponse}
			}}
			ct.run(func(ct *controllerTest) {
	...
	for _, tc := range cases {
		...
		t.Run(tc.name, func(t *testing.T) {
			ct := &controllerTest{t: t, broker: getTestBroker(), instance: func() *v1beta1.ServiceInstance {
				...
				catalogResponse.Services[0].Plans = append(catalogResponse.Services[0].Plans, osb.Plan{Name: otherPlanName, Free: truePtr(), ID: otherPlanID, Description: "another test plan"})
			}}
			ct.run(func(ct *controllerTest) {
				if tc.useExternalNames {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			...
			ct.run(func(ct *controllerTest) {
				...
				if err := util.WaitForInstanceCondition(ct.client, testNamespace, testInstanceName, v1beta1.ServiceInstanceCondition{Type: v1beta1.ServiceInstanceConditionReady, Status: v1beta1.ConditionFalse, Reason: "ReferencesNonexistentServicePlan"}); err != nil {
					t.Fatalf("error waiting for instance reconciliation to fail: %v", err)
				}
			})
		})
		...
		t.Run(tc.name, func(t *testing.T) {
			ct := &controllerTest{t: t, broker: getTestBroker(), instance: func() *v1beta1.ServiceInstance {
				...
				if tc.createdWithParams {
					i.Spec.Parameters = convertParametersIntoRawExtension(t, map[string]interface{}{"param-key": "param-value"})
				}
				if tc.createdWithParamsFromSecret {
					i.Spec.ParametersFrom = []v1beta1.ParametersFromSource{{SecretKeyRef: &v1beta1.SecretKeyReference{Name: "secret-name", Key: "secret-key"}}}
				}
				return i
			}(), setup: func(ct *controllerTest) {
				prependGetSecretReaction(ct.kubeClient, "secret-name", map[string][]byte{"secret-key": []byte(`{"secret-param-key":"secret-param-value"}`)})
				prependGetSecretReaction(ct.kubeClient, "other-secret-name", map[string][]byte{"other-secret-key": []byte(`{"other-secret-param-key":"other-secret-param-value"}`)})
			}}
			ct.run(func(ct *controllerTest) {
				if tc.updateParams {
					ct.instance.Spec.Parameters = convertParametersIntoRawExtension(t, map[string]interface{}{"param-key": "new-param-value"})
				} else if tc.deleteParams {
					ct.instance.Spec.Parameters = nil
				}
				if tc.updateParamsFromSecret {
					ct.instance.Spec.ParametersFrom = []v1beta1.ParametersFromSource{{SecretKeyRef: &v1beta1.SecretKeyReference{Name: "other-secret-name", Key: "other-secret-key"}}}
				} else if tc.deleteParamsFromSecret {
					ct.instance.Spec.ParametersFrom = nil
				}
				if tc.updateSecret {
					ct.kubeClient.Lock()
					prependGetSecretReaction(ct.kubeClient, "secret-name", map[string][]byte{"secret-key": []byte(`{"new-secret-param-key":"new-secret-param-value"}`)})
...
func TestCreateServiceInstanceWithRetries(t *testing.T) {
	...
	cases := []struct {
		name	string
		setup	func(ct *controllerTest)
	}{{name: "no retry", setup: func(ct *controllerTest) {
		ct.osbClient.ProvisionReaction = &fakeosb.ProvisionReaction{Response: &osb.ProvisionResponse{}}
	}}, {name: "retry after temporary error without orphan mitigation", setup: func(ct *controllerTest) {
		ct.osbClient.ProvisionReaction = fakeosb.DynamicProvisionReaction(getProvisionResponseByPollCountReactions(2, []fakeosb.ProvisionReaction{fakeosb.ProvisionReaction{Error: osb.HTTPStatusCodeError{StatusCode: http.StatusUnauthorized, ErrorMessage: strPtr("unauthorized; retry later"), Description: strPtr("temporary error that can be retried without orphan mitigation")}}, fakeosb.ProvisionReaction{Response: &osb.ProvisionResponse{}}}))
	}}, {name: "retry after temporary error with orphan mitigation", setup: func(ct *controllerTest) {
		ct.osbClient.ProvisionReaction = fakeosb.DynamicProvisionReaction(getProvisionResponseByPollCountReactions(2, []fakeosb.ProvisionReaction{fakeosb.ProvisionReaction{Error: osb.HTTPStatusCodeError{StatusCode: http.StatusInternalServerError, ErrorMessage: strPtr("something is broken"), Description: strPtr("temporary error that can be retried after orphan mitigation")}}, fakeosb.ProvisionReaction{Response: &osb.ProvisionResponse{}}}))
	}}}
	for _, tc := range cases {
		tc := tc
		t.Run(tc.name, func(t *testing.T) {
			ct := &controllerTest{t: t, broker: getTestBroker(), instance: getTestInstance()}
			ct.setup = tc.setup
			ct.run(func(ct *controllerTest) {
				verifyCondition := v1beta1.ServiceInstanceCondition{Type: v1beta1.ServiceInstanceConditionReady, Status: v1beta1.ConditionTrue, Reason: "ProvisionedSuccessfully"}
...
func TestCreateServiceInstanceWithInvalidParameters(t *testing.T) {
	...
	ct.run(func(ct *controllerTest) {
		...
		instance.Spec.Parameters = convertParametersIntoRawExtension(t, map[string]interface{}{"Name": "test-param", "Args": map[string]interface{}{"first": "first-arg", "second": "second-arg"}})
...
func FlakeTestCreateServiceInstanceWithProvisionFailure(t *testing.T) {
	...
	}{{name: "Status OK", statusCode: http.StatusOK, provisionErrorReason: "ProvisionCallFailed"}, {name: "Status Created", statusCode: http.StatusCreated, provisionErrorReason: "ProvisionCallFailed", triggersOrphanMitigation: true}, {name: "other 2xx", statusCode: http.StatusNoContent, provisionErrorReason: "ProvisionCallFailed", triggersOrphanMitigation: true}, {name: "3XX", statusCode: 300, provisionErrorReason: "ProvisionCallFailed"}, {name: "Status Request Timeout", statusCode: http.StatusRequestTimeout, provisionErrorReason: "ProvisionCallFailed", triggersOrphanMitigation: false}, {name: "400", statusCode: 400, provisionErrorReason: "ProvisionCallFailed", failReason: "ClusterServiceBrokerReturnedFailure"}, {name: "other 4XX", statusCode: 403, provisionErrorReason: "ProvisionCallFailed"}, {name: "5XX", statusCode: 500, provisionErrorReason: "ProvisionCallFailed", triggersOrphanMitigation: true}, {name: "non-url transport error", nonHTTPResponseError: fmt.Errorf("non-url error"), provisionErrorReason: "ErrorCallingProvision"}, {name: "non-timeout url error", nonHTTPResponseError: &url.Error{Op: "Put", URL: "https://fakebroker.com/v2/service_instances/instance_id", Err: fmt.Errorf("non-timeout error")}, provisionErrorReason: "ErrorCallingProvision"}, {name: "network timeout", nonHTTPResponseError: &url.Error{Op: "Put", URL: "https://fakebroker.com/v2/service_instances/instance_id", Err: TimeoutError("timeout error")}, provisionErrorReason: "ErrorCallingProvision", triggersOrphanMitigation: true}}
	for _, tc := range cases {
		tc := tc
		t.Run(tc.name, func(t *testing.T) {
			...
			ct := &controllerTest{t: t, broker: getTestBroker(), instance: getTestInstance(), skipVerifyingInstanceSuccess: true, setup: func(ct *controllerTest) {
				...
				if reactionError == nil {
					reactionError = osb.HTTPStatusCodeError{StatusCode: tc.statusCode, ErrorMessage: strPtr("error message"), Description: strPtr("response description")}
				}
				respondSuccessfullyToProvision := false
				ct.osbClient.ProvisionReaction = fakeosb.DynamicProvisionReaction(func(r *osb.ProvisionRequest) (*osb.ProvisionResponse, error) {
					select {
				...
				ct.osbClient.DeprovisionReaction = fakeosb.DynamicDeprovisionReaction(func(r *osb.DeprovisionRequest) (*osb.DeprovisionResponse, error) {
					...
					return nil, osb.HTTPStatusCodeError{StatusCode: 500, ErrorMessage: strPtr("temporary deprovision error")}
				})
			}}
			ct.run(func(ct *controllerTest) {
				condition := v1beta1.ServiceInstanceCondition{Type: v1beta1.ServiceInstanceConditionReady, Status: v1beta1.ConditionFalse, Reason: tc.provisionErrorReason}
				...
				deprovisionBlockChan <- false
				if tc.triggersOrphanMitigation {
					if err := util.WaitForInstanceCondition(ct.client, testNamespace, testInstanceName, v1beta1.ServiceInstanceCondition{Type: v1beta1.ServiceInstanceConditionReady, Status: v1beta1.ConditionUnknown}); err != nil {
						t.Fatalf("error waiting for instance deprovision to fail: %v", err)
					}
				}
				provisionSuccessChan <- true
				deprovisionSuccessChan <- true
				if err := util.WaitForInstanceCondition(ct.client, testNamespace, testInstanceName, v1beta1.ServiceInstanceCondition{Type: v1beta1.ServiceInstanceConditionReady, Status: v1beta1.ConditionTrue}); err != nil {
...
func TestCreateServiceInstanceFailsWithNonexistentPlan(t *testing.T) {
	...
	ct := &controllerTest{t: t, broker: getTestBroker(), instance: getTestInstance(), skipVerifyingInstanceSuccess: true, preCreateInstance: func(ct *controllerTest) {
		...
		catalogResponse := ct.osbClient.CatalogReaction.(*fakeosb.CatalogReaction).Response
		catalogResponse.Services[0].PlanUpdatable = truePtr()
		catalogResponse.Services[0].Plans = []osb.Plan{{Name: otherPlanName, Free: truePtr(), ID: otherPlanID, Description: "another test plan"}}
	...
	ct.run(func(ct *controllerTest) {
		condition := v1beta1.ServiceInstanceCondition{Type: v1beta1.ServiceInstanceConditionReady, Status: v1beta1.ConditionFalse, Reason: "ReferencesNonexistentServicePlan"}
		if err := util.WaitForInstanceCondition(ct.client, testNamespace, testInstanceName, condition); err != nil {
			t.Fatalf("error waiting for instance condition: %v", err)
		}
	})
...
func TestCreateServiceInstanceAsynchronous(t *testing.T) {
	...
	}{{name: "asynchronous provision with operation key", osbResponse: &osb.ProvisionResponse{Async: true, DashboardURL: &dashURL, OperationKey: &key}}, {name: "asynchronous provision without operation key", osbResponse: &osb.ProvisionResponse{Async: true, DashboardURL: &dashURL}}}
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			ct := &controllerTest{t: t, broker: getTestBroker(), instance: getTestInstance(), setup: func(ct *controllerTest) {
				ct.osbClient.ProvisionReaction = &fakeosb.ProvisionReaction{Response: tc.osbResponse}
			}}
			ct.run(func(ct *controllerTest) {
				...
				condition := v1beta1.ServiceInstanceCondition{Type: v1beta1.ServiceInstanceConditionReady, Status: v1beta1.ConditionTrue, Reason: "ProvisionedSuccessfully"}
				if err := util.WaitForInstanceCondition(ct.client, testNamespace, testInstanceName, condition); err != nil {
					t.Fatalf("error waiting for instance condition: %v", err)
				}
			})
...
func TestDeleteServiceInstance(t *testing.T) {
	...
	cases := []struct {
	...
	}{{name: "synchronous deprovision", binding: getTestBinding(), setup: func(ct *controllerTest) {
		ct.osbClient.DeprovisionReaction = &fakeosb.DeprovisionReaction{Response: &osb.DeprovisionResponse{}}
	}}, {name: "synchronous deprovision, no binding", setup: func(ct *controllerTest) {
		ct.osbClient.DeprovisionReaction = &fakeosb.DeprovisionReaction{Response: &osb.DeprovisionResponse{}}
	}}, {name: "asynchronous deprovision with operation key", binding: getTestBinding(), setup: func(ct *controllerTest) {
		ct.osbClient.DeprovisionReaction = &fakeosb.DeprovisionReaction{Response: &osb.DeprovisionResponse{Async: true, OperationKey: &key}}
	}}, {name: "asynchronous deprovision with operation key, no binding", setup: func(ct *controllerTest) {
		ct.osbClient.DeprovisionReaction = &fakeosb.DeprovisionReaction{Response: &osb.DeprovisionResponse{Async: true, OperationKey: &key}}
	}}, {name: "asynchronous deprovision without operation key", binding: getTestBinding(), setup: func(ct *controllerTest) {
		ct.osbClient.DeprovisionReaction = &fakeosb.DeprovisionReaction{Response: &osb.DeprovisionResponse{Async: true}}
	}}, {name: "asynchronous deprovision without operation key, no binding", setup: func(ct *controllerTest) {
		ct.osbClient.DeprovisionReaction = &fakeosb.DeprovisionReaction{Response: &osb.DeprovisionResponse{Async: true}}
	}}, {name: "deprovision instance with binding not deleted", binding: getTestBinding(), setup: func(ct *controllerTest) {
		ct.osbClient.DeprovisionReaction = &fakeosb.DeprovisionReaction{Response: &osb.DeprovisionResponse{}}
		...
		condition := v1beta1.ServiceInstanceCondition{Type: v1beta1.ServiceInstanceConditionReady, Status: v1beta1.ConditionFalse, Reason: "DeprovisionBlockedByExistingCredentials"}
		if err := util.WaitForInstanceCondition(ct.client, testNamespace, testInstanceName, condition); err != nil {
			ct.t.Fatalf("error waiting for instance condition: %v", err)
		}
		ct.instance = nil
	}}, {name: "deprovision instance after in progress provision", skipVerifyingInstanceSuccess: true, setup: func(ct *controllerTest) {
		ct.osbClient.PollLastOperationReaction = fakeosb.DynamicPollLastOperationReaction(getLastOperationResponseByPollCountReactions(2, []fakeosb.PollLastOperationReaction{fakeosb.PollLastOperationReaction{Response: &osb.LastOperationResponse{State: osb.StateInProgress}}, fakeosb.PollLastOperationReaction{Response: &osb.LastOperationResponse{State: osb.StateSucceeded}}}))
		ct.osbClient.ProvisionReaction = &fakeosb.ProvisionReaction{Response: &osb.ProvisionResponse{Async: true}}
		ct.osbClient.DeprovisionReaction = &fakeosb.DeprovisionReaction{Response: &osb.DeprovisionResponse{}}
	}, testFunction: func(ct *controllerTest) {
		verifyCondition := v1beta1.ServiceInstanceCondition{Type: v1beta1.ServiceInstanceConditionReady, Status: v1beta1.ConditionTrue, Reason: "ProvisionedSuccessfully"}
		if err := util.WaitForInstanceCondition(ct.client, testNamespace, testInstanceName, verifyCondition); err != nil {
	...
	for _, tc := range cases {
		tc := tc
		t.Run(tc.name, func(t *testing.T) {
			ct := &controllerTest{t: t, broker: getTestBroker(), binding: tc.binding, instance: getTestInstance(), skipVerifyingInstanceSuccess: tc.skipVerifyingInstanceSuccess, setup: tc.setup}
...
func TestPollServiceInstanceLastOperationSuccess(t *testing.T) {
	...
	cases := []struct {
	...
	}{{name: "async provisioning with last operation response state in progress", setup: func(ct *controllerTest) {
		ct.osbClient.ProvisionReaction = &fakeosb.ProvisionReaction{Response: &osb.ProvisionResponse{Async: true}}
		ct.osbClient.PollLastOperationReaction = fakeosb.DynamicPollLastOperationReaction(getLastOperationResponseByPollCountStates(2, []osb.LastOperationState{osb.StateInProgress, osb.StateSucceeded}))
	}, skipVerifyingInstanceSuccess: true, verifyCondition: &v1beta1.ServiceInstanceCondition{Type: v1beta1.ServiceInstanceConditionReady, Status: v1beta1.ConditionTrue, Reason: "ProvisionedSuccessfully"}}, {name: "async provisioning with last operation response state succeeded", setup: func(ct *controllerTest) {
		ct.osbClient.ProvisionReaction = &fakeosb.ProvisionReaction{Response: &osb.ProvisionResponse{Async: true}}
		ct.osbClient.PollLastOperationReaction = &fakeosb.PollLastOperationReaction{Response: &osb.LastOperationResponse{State: osb.StateSucceeded, Description: strPtr("testDescription")}}
	}, verifyCondition: &v1beta1.ServiceInstanceCondition{Type: v1beta1.ServiceInstanceConditionReady, Status: v1beta1.ConditionTrue, Reason: "ProvisionedSuccessfully"}}, {name: "async provisioning with error on first poll", setup: func(ct *controllerTest) {
		ct.osbClient.ProvisionReaction = &fakeosb.ProvisionReaction{Response: &osb.ProvisionResponse{Async: true}}
		ct.osbClient.PollLastOperationReaction = fakeosb.DynamicPollLastOperationReaction(getLastOperationResponseByPollCountReactions(2, []fakeosb.PollLastOperationReaction{fakeosb.PollLastOperationReaction{Error: errors.New("some error")}, fakeosb.PollLastOperationReaction{Response: &osb.LastOperationResponse{State: osb.StateSucceeded}}}))
	}, skipVerifyingInstanceSuccess: true, verifyCondition: &v1beta1.ServiceInstanceCondition{Type: v1beta1.ServiceInstanceConditionReady, Status: v1beta1.ConditionTrue, Reason: "ProvisionedSuccessfully"}}, {name: "async provisioning with error on second poll", setup: func(ct *controllerTest) {
		ct.osbClient.ProvisionReaction = &fakeosb.ProvisionReaction{Response: &osb.ProvisionResponse{Async: true}}
		ct.osbClient.PollLastOperationReaction = fakeosb.DynamicPollLastOperationReaction(getLastOperationResponseByPollCountReactions(1, []fakeosb.PollLastOperationReaction{fakeosb.PollLastOperationReaction{Response: &osb.LastOperationResponse{State: osb.StateInProgress}}, fakeosb.PollLastOperationReaction{Error: errors.New("some error")}, fakeosb.PollLastOperationReaction{Response: &osb.LastOperationResponse{State: osb.StateSucceeded}}}))
	}, skipVerifyingInstanceSuccess: true, verifyCondition: &v1beta1.ServiceInstanceCondition{Type: v1beta1.ServiceInstanceConditionReady, Status: v1beta1.ConditionTrue, Reason: "ProvisionedSuccessfully"}}, {name: "async last operation response successful with originating identity", setup: func(ct *controllerTest) {
		...
		ct.osbClient.ProvisionReaction = &fakeosb.ProvisionReaction{Response: &osb.ProvisionResponse{Async: true}}
		ct.osbClient.PollLastOperationReaction = &fakeosb.PollLastOperationReaction{Response: &osb.LastOperationResponse{State: osb.StateSucceeded, Description: strPtr("testDescription")}}
	}, verifyCondition: &v1beta1.ServiceInstanceCondition{Type: v1beta1.ServiceInstanceConditionReady, Status: v1beta1.ConditionTrue, Reason: "ProvisionedSuccessfully"}, preCreateInstance: func(ct *controllerTest) {
	...
	for _, tc := range cases {
		tc := tc
		t.Run(tc.name, func(t *testing.T) {
			ct := &controllerTest{t: t, broker: getTestBroker(), instance: getTestInstance(), skipVerifyingInstanceSuccess: tc.skipVerifyingInstanceSuccess, setup: tc.setup, preDeleteBroker: tc.preDeleteBroker, preCreateInstance: tc.preCreateInstance, postCreateInstance: tc.postCreateInstance}
			ct.run(func(ct *controllerTest) {
...
func TestRetryAsyncDeprovision(t *testing.T) {
	...
	hasPollFailed := false
	ct := &controllerTest{t: t, broker: getTestBroker(), instance: getTestInstance(), setup: func(ct *controllerTest) {
		ct.osbClient.DeprovisionReaction = fakeosb.DynamicDeprovisionReaction(func(_ *osb.DeprovisionRequest) (*osb.DeprovisionResponse, error) {
		...
		ct.osbClient.PollLastOperationReaction = fakeosb.DynamicPollLastOperationReaction(func(_ *osb.LastOperationRequest) (*osb.LastOperationResponse, error) {
			hasPollFailed = true
