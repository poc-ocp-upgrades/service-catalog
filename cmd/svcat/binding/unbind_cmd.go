...
`), PreRunE: command.PreRunE(unbindCmd), RunE: command.RunE(unbindCmd)}
	unbindCmd.AddNamespaceFlags(cmd.Flags(), false)
	cmd.Flags().StringSliceVar(&unbindCmd.bindingNames, "name", []string{}, "The name of the binding to remove")
